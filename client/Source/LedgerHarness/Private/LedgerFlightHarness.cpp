...
void ULedgerFlightHarness::OnWorldBeginPlay(UWorld& InWorld)
{
	...
	for (const TCHAR* Fixture :
		{ TEXT("transect"), TEXT("surfacestudy"), TEXT("turntable"), TEXT("climate"),
		  ...
		  TEXT("windheard"), TEXT("front"), TEXT("wetwatch"), TEXT("stormwatch"), TEXT("airprobe"), TEXT("ridgeflight"), TEXT("entryburn"), TEXT("visorwatch"), TEXT("aurorawatch"), TEXT("volumebudget"), TEXT("stormfront"), TEXT("shiptrial"), TEXT("couplingproof"), TEXT("shippanel"),
